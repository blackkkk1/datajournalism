...
//杀子原因
$(document).ready(function () {
    var childReason1Width = $("#child_reason1").width();
    var childReason1Height = $("#child_reason1").height();
    var childReasonDescHeight = $("#child_reason_desc").height();
    var fixedHeight = childReasonDescHeight + childReason1Height * 1.05;
...
//弃婴原因
$(document).ready(function () {
    var babyReason1Width = $("#baby_reason1").width();
    var babyReason1Height = $("#baby_reason1").height();
    var babyReasonDescHeight = $("#baby_reason_desc").height();
    var fixedHeight = babyReasonDescHeight + babyReason1Height * 1.1;
